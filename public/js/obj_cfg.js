...
class ObjectCategory {
  obj_type_map = {
    Person: {
        color: "#ff0000",
        size: [0.4, 0.5, 1.7],
        attr: ["sitting", "squating", "bending over"],
      },
    Table: { color: "#86af49", size: [2.0, 1.8, 1.5],},

    Chair: { color: "#00ff00", size: [1.0, 1.0, 1.5], },

    Couch: { color: "#ffff00", size: [3.0, 1.5, 1.5] },

    Shelf: { color: "#00ffff", size: [5.0, 1.0, 3] },

    Robot: { color: "#00aaff", size: [1.0, 1.0, 1.0] },

    TrashCan: { color: "#00aaff", size: [0.5, 0.5, 0.5] },
  ...
  popularCategories = ["Table", "Person", "Chair", "Couch", "Shelf", "Robot"];
